...
from .views import DeviationDeploymentView, DeviationUpdateView, FilterForm, InsightDataCreateView,InsightDataDeleteView,InsightDataListView,InsightDataUpdateView,DeviationListView,DeviationCreateView,DeviationDeleteView
